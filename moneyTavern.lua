...
local function sendTavernBonuses()
	...
	if (karas_bonus > 1) then
		...
		SendMail('Драный карась - доход', 'Бонус за активность таверны "Драный карась" (торговый квартал)', 25924, 36, 61, 20, 0, 0, 600057, karas_bonus_ceil); -- мне на персонаж Райка для мониторинга
		SendMail('Драный карась - доход', 'Бонус за активность таверны "Драный карась" (торговый квартал)', 8212, 36, 61, 20, 0, 0, 600057, karas_bonus_ceil); -- 8212 персонаж Хейвинд (Ферриан)
	end
end
