...
local function OnGossipChargerDublon(event, player, object)
    ...
    player:GossipSetText( 'ООС: Тут вы можете обменять персональные дублоны на неперсональные "разменные дублоны" и обратно. Разменными дублонами можно обмениваться с другими игроками, а за персональные - покупать экипировку с бонусами.\n\n После обмена дублоны придут на почту. \n\nКурс покупки и продажи: 1х1 \n\nПродажа персональных дублонов доступна только с 5-го уровня персонажа, а разменный дублон можно сдавать с 1-го!', MenuId )
