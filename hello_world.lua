...
local class_spell_list = {  [1] = {88005, 88006, 88007, 88008, 87001, 87002, 87003, 87004, 87008, 87005, 87006, 87007, 87009, 87010, 86003, 86004, 75}, -- Воин
                            [2] = {88005, 88006, 88007, 88008, 87001, 87002, 87003, 87004, 87008, 87005, 87006, 87007, 87009, 87010, 86005, 86009, 86010}, -- Паладин
                            [3] = {88005, 88006, 88007, 88008, 87001, 87002, 87003, 87004, 87008, 87005, 87006, 87007, 87009, 86003, 86004, 75}, -- Охотник
                            [4] = {88005, 88006, 88007, 88008, 87001, 87002, 87003, 87004, 87008, 87005, 87006, 87007, 87009, 86003, 86004, 75}, -- Разбойник
                            [5] = {88005, 88006, 88007, 88008, 87001, 87002, 87003, 87004, 87008, 86005, 86009, 86010, 86011, 86012}, -- Жрец
                            [6] = {88005, 88006, 88007, 88008, 87001, 87002, 87003, 87004, 87008, 87005, 87006, 87007, 87009}, -- Рыцарь Смерти
                            [7] = {88005, 88006, 88007, 88008, 87001, 87002, 87003, 87004, 87008, 87005, 87006, 87009, 86005, 86006, 86018, 86013, 86007, 86017, 86008}, -- Шаман
                            [8] = {88005, 88006, 88007, 88008, 87001, 87002, 87003, 87004, 87008, 86005, 86006, 86018, 86013, 86007, 86017, 86014, 86015, 86016}, -- Маг
                            [9] = {88005, 88006, 88007, 88008, 87001, 87002, 87003, 87004, 87008, 86005, 86011, 86012, 86013, 86007, 86017}, -- Чернокнижник
                            [11] = {88005, 88006, 88007, 88008, 87001, 87002, 87003, 87004, 87008, 86005, 86008} -- Друид
                            }
...
local function OnPlayerCommand(event, player, command)
    ...
    elseif (string.match(command, 'petfollow$')) then
        ...
        local plGUID = player:GetGUID();
        if(creatorGUID == plGUID) then
            player:SendBroadcastMessage("Вы можете указать дополнительные аргументы:\n .petfollow |r[|cffbbbbbbДистанция от -2 до 4|r] |r[|cffbbbbbbПозиция относительно игрока|r]")
	...
	elseif (string.find(command, " ")) then
		...
		elseif (arguments[1] == "petemote") then
			...
			if(creatorGUID == plGUID)then
				...
				Pet:SendUnitEmote(petName .. "" .. msg);
				return false;
			else
				player:SendBroadcastMessage("ОШИБКА: NPC не является вашим спутником.")
				return false;
			end
		elseif (arguments[1] == "petplay" and (#arguments == 2 or #arguments == 3)) then
			local Pet = player:GetTargetCreature();
			local creatorGUID = Pet:GetControllerGUID();
			local plGUID = player:GetGUID();
			if(creatorGUID == plGUID)then
