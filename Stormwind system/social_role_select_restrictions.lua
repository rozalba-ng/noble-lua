...
local function Player_OnLogin( _, player )
	...
	if Q then
		...
		--	Игрок вступил в Тени Штормграда имея не ту роль
			player:SendBroadcastMessage("|cffFF4500[!!]|r Только игроки имеющие социальную роль \"Вольный Житель\" могут находиться в Тенях Штормграда.")
		end
	end
end
