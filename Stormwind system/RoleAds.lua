...
--	Задержка между объявлениями ОТ .. ДО .. минут (Т.Е. Плавающая задержка для разнообразия..).
CreateLuaEvent( RoleAdv, { 0.2*60000, 0.5*60000 }, repeats ) -- 60000-умножение на миллисекунды. Т.Е. Указываем кол-во минут.